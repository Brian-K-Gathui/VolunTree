...
import { postData } from "../services/api"; // ✅ Ensure correct import

const CreateOrganization = () => { // ✅ Fix component name
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            try {
                await postData("organizations", values); // ✅ Ensure correct endpoint
